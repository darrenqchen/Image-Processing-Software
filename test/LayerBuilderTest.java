...
public class LayerBuilderTest {
  ...
  @Before
  public void init() {
    checkLayer = new PPMLayerBuilder("test/Checkerboard2By2.ppm").build();
  }

  @Test
  public void testPNGBuilder() {
    ILayer layer = new LayerBuilder("test/checker2x2.png").build();
  ...
  public void testJPGBuilder() {
    ILayer layer = new LayerBuilder("test/checker2x2.jpg").build();
