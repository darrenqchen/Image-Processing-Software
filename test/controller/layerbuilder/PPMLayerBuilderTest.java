...
public class PPMLayerBuilderTest {
  ...
  @Before
  public void init() {
    builder1 = new PPMLayerBuilder("test/controller/layerbuilder/Checkerboard2By2.ppm");
    nonExistentBuilder = new PPMLayerBuilder("test/controller/layerbuilder/nonExistent.ppm");
    builder1P6 = new PPMLayerBuilder("test/controller/layerbuilder/Checkerboard2By2P6.ppm");
  }
